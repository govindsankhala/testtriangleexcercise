...
public class UseCaseHandler {
    ...
    public <T extends UseCase.RequestValues, G extends UseCase.ResponseValue> void execute(
            final UseCase<T, G> useCase, T values, UseCase.UseCaseCallback<G> callback) {
